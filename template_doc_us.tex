\documentclass[10pt, letterpaper, titlepage, oneside, openright, final, article]{memoir}
...
\ifdraftdoc
    \usepackage[final=false,colorlinks=true]{hyperref}
\else
    \usepackage[final=true,colorlinks=false]{hyperref}
\fi
\hypersetup{
    $if(title-meta)$
        pdftitle={$title-meta$},
...
% Spacing before and after the section numbers
% Ref: Memoir Class, page 153
...
\setlength{\cftbeforesubsubsectionskip}{0.3em}
...
\makechapterstyle{negerns}{
    ...
    \renewcommand*{\printchapternum}{\chapnumfont \thechapter\space\space\space\space}
    \renewcommand*{\chaptitlefont}{\fontsize{16pt}{1pt}}
...
$if(title)$
    ...
    \begin{flushleft}
        ...
        {\fontsize{12pt}{22pt}\usefont{T1}{ptm}{m}{n}$version$}\\[0.05in]
        {\fontsize{12pt}{22pt}\usefont{T1}{ptm}{m}{n}$date$}
        ...
        % Add a vertical fill so the author(s) is/are pushed down.
        ...
        $for(author)$
            $if(author.name)$
                {\fontsize{13pt}{15pt}\usefont{T1}{ptm}{b}{n}$author.name$}
                $if(author.email)$
                    {\\[0.05in]\fontsize{12pt}{14pt}\usefont{T1}{ptm}{m}{n}$author.email$}
                $endif$
            $endif$
            \\[0.2in]
        $endfor$
        ...
        $if(distribution)$
            {\fontsize{12pt}{14pt}\usefont{T1}{ptm}{m}{n}Distribution: $distribution$}
        $endif$
    \end{flushleft}
$endif$
